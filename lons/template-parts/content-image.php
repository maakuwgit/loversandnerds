 ...
 */
 ...
 $feature_style = $date_str = $client_str = $header_align = $content_style = '';
 $post_id 	= $post->ID;
 $slug 			= $post->post_name;
...
?>
		<div id="<?php echo $slug; ?>" <?php post_class('entry-content ' . ($project ? ' project' : '') . $username . $theme); echo $content_style; ?>>
		<?php
